...
```javascript
Random = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-tools-unary@v0.2.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/random-array-tools-unary/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/random-array-tools-unary/actions/workflows/test.yml?query=branch:v0.2.3
